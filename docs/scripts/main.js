...
app.checkIfProduction = function() {
  if (
    !(
    ...
    //Assuming production, disabling traces on production
    console.trace = function() {};
  }
};
app.checkIfProduction();
...
app.fetchGithubContributors = function() {
  if (app.authors === null || app.authors === undefined) {
    ...
    document.getElementById("contributors").innerHTML = app.authors.length;
    // Since we already have this info, we will exit early.
